...
import bui.quocdat.meetingvideo.Network.ApiClient;
import bui.quocdat.meetingvideo.Network.ApiService;
...
public class IncomingInvitationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imageMeetingType = findViewById(R.id.incoming_iv_audio_or_video);
        ...
        TextView textFirstChar = findViewById(R.id.incoming_tv_first_char);
        TextView textUserName = findViewById(R.id.incoming_tv_user_name);
        TextView textEmail = findViewById(R.id.incoming_tv_email);
        ...
        ImageView imageAcceptInvitation = findViewById(R.id.incoming_iv_accept);
        imageAcceptInvitation.setOnClickListener(view -> sendInvitationResponse(
                Constants.REMOTE_MSG_INVITATION_ACCEPTED,
                getIntent().getStringExtra(Constants.REMOTE_MSG_INVITER_TOKEN)
        ));

        ImageView imageRejectInvitation = findViewById(R.id.incoming_iv_reject);
