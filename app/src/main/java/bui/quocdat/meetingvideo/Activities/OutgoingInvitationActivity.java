...
public class OutgoingInvitationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imageMeetingType = findViewById(R.id.outgoing_iv_audio_or_video);
        ...
        TextView textFirstChar = findViewById(R.id.outgoing_tv_first_char);
        TextView textEmail = findViewById(R.id.outgoing_tv_email);
        TextView textUserName = findViewById(R.id.outgoing_tv_user_name);
        ...
        ImageView imageStopInvitation = findViewById(R.id.outgoing_iv_close);
